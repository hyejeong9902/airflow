...
def make_predict_data():
    ...
    try:
        ...
        # 전전분기 요양종결자(AAA240MT) & 기초장해등급 테이블(BCA201DT)에 없는 원부
        with db_connect.cursor() as cur:
            AAA200MT = pd.read_sql_query('SELECT "WONBU_NO" FROM "AAA240MT" WHERE "WONBU_NO"', db_connect) # "LAST_CHANGE_ILSI"= CURRENT_DATE - 1'
